...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 mb-1">Edit Berita</h1>
            <p class="text-gray-600 text-sm">Perbarui informasi berita</p>
        </div>
    ...
    <form action="{{ route('admin.berita.update', $berita->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div>
            ...
            <div class="mb-4">
                ...
                <img src="{{ asset('storage/' . $berita->foto) }}" alt="Current Image" class="max-w-xs h-48 object-cover rounded-lg shadow-md">
            </div>
            @endif
                ...
                <div class="space-y-1 text-center">
                    ...
                    <div class="flex text-sm text-gray-600">
                        <label for="foto" class="relative cursor-pointer bg-white rounded-md font-medium text-indigo-600 hover:text-indigo-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
                            <span>{{ $berita->foto ? 'Ganti foto' : 'Upload foto' }}</span>
            ...
            <div id="imagePreview" class="mt-4 hidden">
                ...
                <button type="button" onclick="removeImage()" class="mt-2 text-sm text-red-600 hover:text-red-800">Hapus gambar baru</button>
            </div>
