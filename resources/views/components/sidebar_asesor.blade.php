...
<aside id="sidebar-asesor" class="flex flex-col h-screen w-64 bg-white border-r shadow-md fixed z-30 transition-all duration-300">
    <!-- Logo -->
    ...
    <nav class="flex-1 flex flex-col gap-1 px-4">
        <a href="{}"
            class="flex items-center gap-3 px-4 py-3 rounded-lg transition font-semibold text-[14px] font-['Nunito Sans']">
